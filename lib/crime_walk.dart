...
class CrimeWalkModel extends ChangeNotifier
{
  ...
  CrimeWalkModel()
  {
    ...
    crimeWalks.add(CrimeWalk(name: "The Crime Walk 3", description: "A drive through the city of Launceston", yearOccurred: 1500, crimeType: CrimeType.ALL, length: Length.ALL, location: Location.HOBART, difficulty: Difficulty.ALL, transportType: TransportType.CAR));
    crimeWalks.add(CrimeWalk(name: "The Crime Drive 3", description: "A drive through the city of Launceston", yearOccurred: 1670, crimeType: CrimeType.ALL, length: Length.ALL, location: Location.LAUNCESTON, difficulty: Difficulty.ALL, transportType: TransportType.CAR));
    crimeWalks.add(CrimeWalk(name: "The Crime Walk 4", description: "A walk through the city of Hobart", yearOccurred: 1280, crimeType: CrimeType.ALL, length: Length.ALL, location: Location.HOBART, difficulty: Difficulty.ALL, transportType: TransportType.WALK));
    crimeWalks.add(CrimeWalk(name: "The Crime Drive 4", description: "A walk through the city of Hobart", yearOccurred: 1800, crimeType: CrimeType.ALL, length: Length.ALL, location: Location.LAUNCESTON, difficulty: Difficulty.ALL, transportType: TransportType.WALK));
